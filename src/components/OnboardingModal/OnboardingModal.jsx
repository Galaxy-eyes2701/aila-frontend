...
export default function OnboardingModal({ onClose, onComplete }) {
  ...
  useEffect(() => {
    ...
    const fetchTags = async () => {
      ...
      } catch { /* giữ danh sách rỗng */ } finally {
      ...
      <div className={styles.modal}>
        ...
        {step === 1 && (
          <>
            <div className={styles.header}>
              ...
              <h2>Bạn là ai?</h2>
              <p>Chọn nhóm đối tượng phù hợp để chúng tôi gợi ý nội dung tốt hơn cho bạn.</p>
            </div>
            ...
            <div className={styles.footer}>
              <button className={styles.btnSkip} onClick={handleSkip}>Bỏ qua</button>
              <button
        ...
        {step === 2 && (
          <>
            <div className={styles.header}>
              ...
              <p>Điều này giúp chúng tôi gợi ý khóa học phù hợp với trình độ của bạn.</p>
            </div>
            <div className={styles.body}>
                ...
                {KNOWLEDGE_LEVELS.map(({ value, label, desc, icon }) => (
                  ...
                  >
                    ...
                    {knowledgeLevel === value && (
                      <i className="fas fa-check-circle" style={{ color: 'var(--primary)', fontSize: 18 }} />
                    )}
                  </div>
                ))}
              </div>
        ...
        {step === 3 && (
          <>
            <div className={styles.header}>
              ...
              <p>Chọn các lĩnh vực bạn quan tâm để nhận gợi ý khóa học phù hợp.</p>
            </div>
            <div className={styles.body}>
              <p className={styles.tagHint}>Chọn ít nhất 1 lĩnh vực (có thể chọn nhiều)</p>
              {tagsLoading ? (
        ...
        {step === 4 && (
          <div className={styles.successBody}>
            ...
            <p>
              Hồ sơ của bạn đã được cập nhật. Chúng tôi đã chuẩn bị những khóa học
              phù hợp nhất cho bạn. Hãy bắt đầu học ngay nhé!
            </p>
            <button className={styles.btnStart} onClick={() => { onComplete?.(); onClose?.(); }}>
              Bắt đầu học ngay 🚀
            </button>
          </div>
        )}
